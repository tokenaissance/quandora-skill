...
the agent (as its owner) to connect Quandora: the skill's SKILL.md frontmatter
declares the server, FastAgent connects it through its own MCP connection flow, and
the authorization URL is handed to you to approve.
