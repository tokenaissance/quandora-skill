---
name: paper-trading
description: Use when the user asks for simulated trading, paper trading, current Paper PnL or assets, Paper positions/fills/funding/equity/code, stopping a Paper run, or a Strategy Portfolio Paper workflow on Quandora.
---
...
attempt has occurred, call it once before the business entry point. Pass `3.0-preview` verbatim as
